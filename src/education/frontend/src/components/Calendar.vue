<template>
  <div class="p-5 h-full">
    ...
    <div class="h-[92%] min-h-[600px] min-w-[600px]">
      ...
      <!-- Date Grid -->
      <div
        class="grid grid-cols-7 border-t-[1px] border-s-[1px] h-full w-full grid-rows-6"
      >
        <div
          v-for="date in currentMonthDates"
          class="border-e-[1px] border-b-[1px] border-gray-200"
        >
          <div
...
import { isRtl as checkRtl } from '@/utils/direction'
